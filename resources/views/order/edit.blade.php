            ...
            <section class="steps section container"  >
                <div class="steps__bg">
                    ...
                    <div class="steps__container grid">
                             ...
                             <form action="{{route('orders.update' , $order->id) }}" method="POST" class="contact__form">
                                    @csrf
                                    @method('PUT')
                                    <div class="contact__inputs">
                                    <div class="contact__content">
                                        <input type="text" placeholder=" " name="nawloon" class="contact__input"  value="{{$order->nawloon}}">
                                        <label for="" class="contact__label w color"style="font-size:16px">Freight's type</label>
                                    </div>

                                    <div class="contact__content">
                                        <input type="number" placeholder=" "  name="nawloon_value" class="contact__input"  value="{{$order->nawloon_value}}">
                                        <label for="" class="contact__label w color"style="font-size:16px">Freight's value</label>
                                    </div>

                                    <div class="contact__content">
                                        <input type="number" placeholder=" " name="quantity" class="contact__input"  value="{{$order->quantity}}">
                                        <label for="" class="contact__label w color"style="font-size:16px">Quantity</label>
                                    </div>

                                    <div class="contact__content">
                                        <input type="number" placeholder=" " name="driver_money" class="contact__input"  value="{{$order->driver_money}}">
                                        <label for="" class="contact__label w color"style="font-size:16px">Driver's money</label>
                                    </div>

                                    <div class="contact__content">
                                        <input type="number" placeholder=" " name="user_id" class="contact__input"  value="{{$order->user_id}}">
