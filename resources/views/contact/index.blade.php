...
@section('content')
    ...
    <div class="contact__container grid" style="padding-top: 100px">
        ...
        <form action="{{ route('contacts.index') }}" method="GET" class="contact__form ">
            @csrf
        ...
        <form action="{{ route('contacts.create') }}" class="contact__form o">

            <div class="form group row mt-2  ">

                <div>
                <a class=" btn btn-danger y  mr-3 pb-2" href="{{ route('contacts.trash') }}" role="button">
    ...
    <div class="card" style="padding-top: 10px;">
        ...
        <div class="card-header">
            <h2 class="card-title" style="font-size:30px; font-weight:bold"> All Contacts </h2>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('contacts.show', $d->id) }}">
                                ...
                                <a class="btn btn-danger btn-sm" href="{{ route('soft.delete9', $d->id) }}">
