...
@section('content')
    ...
    <div class="contact__container grid" style="padding-top: 100px">
        ...
        <form  class="contact__form o ">
           ...
           <a class=" btn btn-danger y   mb-1 pb-6 " href="{{ route('contacts.index') }}" role="button">
    ...
    <div class="card" style="padding-top: 10px;">
        <div class="card" style="padding-top: 10px;">
            ...
            <div class="card-header">
                <h2 class="card-title" style="font-size:30px; font-weight:bold"> All Trashed Contacts </h2>
            </div>
                ...
                <tbody>
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td>{{ $d->created_at }}</td>
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('contact.back.from.trash', $d->id) }}">
                                ...
                                <a class="btn btn-info btn-sm" style="background-color: black"
                                    href="{{ route('contact.delete.from.database', $d->id) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
