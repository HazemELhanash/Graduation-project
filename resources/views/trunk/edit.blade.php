            ...
            <section class="steps section container"  >
                <div class="steps__bg">
                    ...
                    <div class="steps__container grid">
                             ...
                             <form action="{{route('trunks.update' , $trunk->id) }}" method="POST" class="contact__form">
                                    @csrf
                                    @method('PUT')
                                    <div class="contact__inputs">
                                    <div class="contact__content">
                                        <input type="text" placeholder=" "  name="trunk_code" class="contact__input"  value="{{$trunk->trunk_code}}">
