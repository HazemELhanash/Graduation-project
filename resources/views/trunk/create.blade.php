                ...
                <div class="contact__container grid">
                    <div class="contact__box">
                        <h2 class="section__title" style="font-size: 50px">
                            To create truck  <br> Please enter this <br> data
                            <img src="{{asset('assets/img/paper.png')}}" alt="" class="about__img">
                        </h2>

                    </div>

                    <form action="{{route('trunks.store')}}" method="POST" class="contact__form">
                        @csrf
                        ...
                        <div class="contact__inputs">
                            ...
                            <div class="contact__content">
                                <input type="text" placeholder=" " name="trunk_code" class="contact__input gr">
                                <label for="" class="contact__label">Truck Code</label>
                            </div>
