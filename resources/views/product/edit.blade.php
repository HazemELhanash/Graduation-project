            ...
            <section class="steps section container"  >
                <div class="steps__bg">
                    ...
                    <div class="steps__container grid">
                             ...
                             <form action="{{route('products.update', $product->id) }}" method="POST" class="contact__form">
                                    @csrf
                                    @method('PUT')
                                    <div class="contact__inputs">
                                    <div class="contact__content">
                                        <input type="text" placeholder=" " name="type" class="contact__input"  value="{{$product->type}}">
                                        <label for="" class="contact__label w">Type</label>
                                    </div>

                                    <div class="contact__content">
                                        <input type="text" placeholder=" "  name="option" class="contact__input"  value="{{$product->option}}">
                                        <label for="" class="contact__label w">Option</label>
                                    </div>
                                    <div class="contact__content">
                                        <input type="text" placeholder=" "  name="order_id" class="contact__input"  value="{{$product->order_id}}">
