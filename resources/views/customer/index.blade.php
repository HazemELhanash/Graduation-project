...
@section('content')
    ...
    <div class="contact__container grid" style="padding-top: 100px">
        ...
        <form action="{{ route('customers.index') }}" method="GET" class="contact__form ">
            @csrf
        ...
        <form  action="{{ route('customers.create') }}" class="contact__form o ">
            ...
            <div>
            <a class=" btn btn-danger y  mr-3 pb-2" href="{{ route('customers.trash') }}" role="button">
    ...
    <div class="card" style="padding-top: 10px;">
        ...
        <div class="card-header">
            <h2 class="card-title" style="font-size:30px; font-weight:bold"> All Customers </h2>
        </div>
                ...
                <tbody>
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td>{{ $d->updated_at }}</td>
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('customers.show', $d->id) }}">
                                ...
                                <a class="btn btn-info btn-sm" href="{{ route('customers.edit', $d->id) }}">
                                ...
                                <a class="btn btn-danger btn-sm" href="{{ route('soft.delete1', $d->id) }}">
