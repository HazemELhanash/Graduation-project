                ...
                <div class="steps__bg">
                    ...
                    <div class="steps__container grid">
                             ...
                             <div class="contact__content">
                                ...
                                <input type="text" placeholder=" " class="contact__input" readonly name="name" value="{{$customer->name}}">
                                <label for="" class="contact__label w color"style="font-size:16px">Name</label>
                            </div>

                            <div class="contact__content">
                                <input type="text" placeholder=" " class="contact__input" readonly name="phone" value="{{$customer->phone}}">
                                <label for="" class="contact__label w color"style="font-size:16px">Phone</label>
                            </div>

                            <div class="contact__content">
                                <input type="text" placeholder=" " class="contact__input" readonly name="address" value="{{$customer->address}}">
