    ...
    <body>
        ...
        <main class="main">
            ...
            <section class="steps section container"  >
                <div class="steps__bg">
                    <a href="{{route('customers.index')}}" style="color: white  ">
                    ...
                    <div class="steps__container grid">
                             ...
                             <form action="{{route('customers.update' , $customer->id) }}" method="POST" class="contact__form">
                                    @csrf
                                    @method('PUT')
                                    <div class="contact__inputs">
                                    <div class="contact__content">
                                        <input type="text" placeholder=" " name="name" class="contact__input"  value="{{$customer->name}}">
                                        <label for="" class="contact__label w color"style="font-size:16px">Name</label>
                                    </div>

                                    <div class="contact__content">
                                        <input type="text" placeholder=" "  name="phone" class="contact__input"  value="{{$customer->phone}}">
                                        <label for="" class="contact__label w color"style="font-size:16px">Phone</label>
                                    </div>

                                    <div class="contact__content">
                                        <input type="text" placeholder=" "  name="address" class="contact__input"  value="{{$customer->address}}">
                                        <label for="" class="contact__label w color"style="font-size:16px">Address</label>
                                    </div>
