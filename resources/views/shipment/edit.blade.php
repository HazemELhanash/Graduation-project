            ...
            <div class="steps__bg">
                ...
                <div class="steps__container grid">
                         ...
                         <form action="{{route('shipments.update' , $shipment->id) }}" method="POST" class="contact__form">
                            ...
                            <input type="text" placeholder=" " class="contact__input" name="load_place" readonly value="{{$shipment->load_place}}" style="margin-top: 5px">
                        ...
                        <div class="contact__content">
                            <input type="text" placeholder=" " class="contact__input"name="counter_end"  value="{{$shipment->counter_end}}">
                        ...
                        <div class="contact__content">
                            <input type="text" placeholder=" " class="contact__input" name="order_id" value="{{$shipment->order_id}}">
...
{{--
                        <div class="contact__content">
                            ...
                            <label for="" class="contact__label w"> الحالة </label>
                        </div> --}}
                        ...
                        <div class="contact__content">
                            ...
                            <label for="" class="contact__label  w color">الحالة </label>
                        </div>
