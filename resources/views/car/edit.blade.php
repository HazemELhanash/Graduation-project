            ...
            <section class="steps section container"  >
                <div class="steps__bg">
                    ...
                    <div class="steps__container grid">
                             ...
                             <form action="{{route('cars.update' , $car->id) }}" method="POST" class="contact__form">
                                    @csrf
                                    @method('PUT')
                                    <div class="contact__inputs">
                                    <div class="contact__content">
                                        <input type="text" placeholder=" " name="car_number" class="contact__input"  value="{{$car->car_number}}">
                                        <label for="" class="contact__label w color"style="font-size:16px"> Car's Number</label>
                                    </div>

                                    <div class="contact__content">
                                        <input type="text" placeholder=" "  name="car_code" class="contact__input"  value="{{$car->car_code}}">
