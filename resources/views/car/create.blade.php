                ...
                <div class="contact__container grid">
                    <div class="contact__box">
                        <h2 class="section__title" style="font-size: 50px">
                            To create car  <br> Please enter this <br> data
                            <img src="{{asset('assets/img/paper.png')}}" alt="" class="about__img">
                        </h2>

                    </div>

                    <form action="{{route('cars.store')}}" method="POST" class="contact__form">
                        @csrf
                        ...
                        <div class="contact__inputs">
                            ...
                            <div class="contact__content">
                                <input type="text" placeholder=" " name="car_number" class="contact__input">
                                <label for="" class="contact__label">Car's Number  </label>
                            </div>

                            <div class="contact__content">
                                <input type="text" placeholder=" " name="car_code" class="contact__input">
                                <label for="" class="contact__label "> Car's Code</label>
                            </div>
