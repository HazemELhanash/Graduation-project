    ...
    <body>
        ...
        <main class="main">
            ...
            <section class="steps section container"  >
                <div class="steps__bg">
                    <a href="{{route('cars.index')}}" style="color: white  ">
                    ...
                    <div class="steps__container grid">
                             ...
                             <div class="contact__content">
                                ...
                                <input type="text" placeholder=" " class="contact__input" readonly name="car_number" value="{{$car->car_number}}">
                                <label for="" class="contact__label w color"style="font-size:16px"> Car's Number </label>
                            </div>

                            <div class="contact__content">
                                <input type="text" placeholder=" " class="contact__input" readonly name="car_code" value="{{$car->car_code}}">
                                <label for="" class="contact__label w color"style="font-size:16px"> Car's Code</label>
                            </div>
                    ...
                    <form action="" class="contact__form">
                        ...
                        <div class="contact__inputs ">
                           <div style="margin-right: 50%;">
                            ...
                            <div class="contact__content">
                                <input type="text" placeholder=" " class="contact__input" readonly>
                                <label for="" class="contact__label w color"style="font-size:16px">Load place</label>
                            </div>
                            <div class="contact__content">
                                <input type="text" placeholder=" " class="contact__input" readonly>
                                <label for="" class="contact__label w color"style="font-size:16px">Off-load place</label>
                            </div>
                            </div>
                        </div>
