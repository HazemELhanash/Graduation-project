...
@section('content')
    ...
    <div class="contact__container grid" style="padding-top: 100px">
        ...
        <form action="{{ route('cars.index') }}" method="GET" class="contact__form ">
            ...
            <div class="form group row m">
                ...
                <div class=" col-md-2  mt-5 mb-4 mr-">
        ...
        <form  class="contact__form o ">
           ...
           <a class=" btn btn-danger y   mb-1 pb-6 " href="{{ route('cars.index') }}" role="button">
    ...
    <div class="card" style="padding-top: 10px;">
        ...
        <div class="card-header">
            <h2 class="card-title" style="font-size:30px; font-weight:bold"> All Trashed cars </h2>
        </div>
                ...
                <tbody>
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td>{{ $d->updated_at }}</td>
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('car.back.from.trash', $d->id) }}">
                                ...
                                <a class="btn btn-info btn-sm" style="background-color: black"
                                    href="{{ route('car.delete.from.database', $d->id) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
