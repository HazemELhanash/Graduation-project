...
@section('content')
    ...
    <div class="contact__container grid" style="padding-top: 100px">
        ...
        <form action="{{ route('drivers.index') }}" method="GET" class="contact__form ">
            @csrf
        ...
        <form action="{{ route('drivers.create') }}" class="contact__form o">
            <div class="form group row mt-2  ">
                ...
                <div>
                <a class=" btn btn-danger y  mr-3 pb-2" href="{{ route('drivers.trash') }}" role="button">
    ...
    <div class="card" style="padding-top: 10px;">
        ...
        <div class="card-header">
            <h2 class="card-title" style="font-size:30px; font-weight:bold"> All Drivers </h2>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td>{{ $d->address }}</td>
                            <td>{{ $d->money }}</td>
                            <td> <a href=" {{ route("getReport" , $d->id )}} " > Report </a> </td>
                            ...
                            <td>{{ $d->updated_at }}</td>
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('drivers.show', $d->id) }}">
                                ...
                                <a class="btn btn-info btn-sm" href="{{ route('drivers.edit', $d->id) }}">
                                ...
                                <a class="btn btn-danger btn-sm" href="{{ route('soft.delete2', $d->id) }}">
                                ...
                                {{-- <form action="{{ route('cars.destroy', $d->id) }}" method="POST">
                                    @csrf
