            ...
            <section class="steps section container"  >
                <div class="steps__bg">
                    ...
                    <div class="steps__container grid">
                             ...
                             <form action="{{route('drivers.update' , $driver->id) }}" method="POST" class="contact__form">
                                    @csrf
                                    @method('PUT')
                                    <div class="contact__inputs">
                                    <div class="contact__content">
                                        <input type="text" placeholder=" " name="name" class="contact__input"  value="{{$driver->name}}">
                                        <label for="" class="contact__label  w color" style="font-size:16px">Driver Name</label>
                                    </div>

                                    <div class="contact__content">
                                        <input type="text" placeholder=" "  name="phone" class="contact__input"  value="{{$driver->phone}}">
                                        <label for="" class="contact__label w color" style="font-size:16px">Driver Phone</label>
                                    </div>
                                    <div class="contact__content">
                                        <input type="text" placeholder=" "  name="address" class="contact__input"  value="{{$driver->address}}">
                                        <label for="" class="contact__label  w color" style="font-size:16px">Driver Address</label>
                                    </div>
                                    <div class="contact__content">
                                        <input type="text" placeholder=" "  name="money" class="contact__input"  value="{{$driver->money}}">
                                        <label for="" class="contact__label w color" style="font-size:16px">Driver Money</label>
                                    </div>

                                    </div>

                            <button class="button button--flex bt">
                                Update driver
