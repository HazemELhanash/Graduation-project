...
@section('content')
    ...
    <div class="card" style="padding-top: 10px;">
        ...
        <div class="card-header">
            <h2 class="card-title" style="font-size:30px; font-weight:bold"> All Trashed Drivers </h2>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td>{{ $d->updated_at }}</td>
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('driver.back.from.trash', $d->id) }}">
                                ...
                                <a class="btn btn-info btn-sm" style="background-color: black"
                                    href="{{ route('driver.delete.from.database', $d->id) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
