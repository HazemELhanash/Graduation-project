...
<body>
    ...
    <main class="main">
        ...
        <section class="steps section container">
            ...
            <div class="steps__bg">
                <a href="{{route('orderReq.index')}}" style="color: white  ">
                ...
                <div class="steps__container grid">
                    ...
                    <div class="contact__content ">
                        ...
                        <input type="text" placeholder=" " class="contact__input color1" readonly value="{{ $data->name }}">
                    ...
                    <div class="contact__content">
                        <input type="text" placeholder=" " class="contact__input color1" readonly
                            value="{{ $data->phone_1 }}">
                        <label for="" class="contact__label w color"style="font-size:16px">Phone 1</label>
                    </div>

                    <div class="contact__content">
                        <input type="text" placeholder=" " class="contact__input color1" readonly
                            value="{{ $data->phone_2 }}">
                        <label for="" class="contact__label w color"style="font-size:16px">Phone 2</label>
                    </div>
