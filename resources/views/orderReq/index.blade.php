...
@section('content')
    ...
    <div class="contact__container grid" style="padding-top: 100px">
        ...
        <form action="{{ route('orderRequests') }}" method="GET" class="contact__form ">
            @csrf
        ...
        <form action="" class="contact__form o">
            <div class="form group row mt-2  ">
                <div>
                <a class=" btn btn-danger y  mr-3 pb-2" href="{{ route('orderReq.trash') }}" role="button">
    ...
    <div class="card" style="padding-top: 10px;">
        ...
        <div class="card-header">
            <h2 class="card-title" style="font-size:30px; font-weight:bold"> All Order requests </h2>
        </div>
                ...
                <tbody>
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#advanced-search/from=ayaabdelhalem179%40gmail.com&isrefinement=true&fromdisplay=Aya+Abdelhalem?compose=new">
                                ...
                                <a class="btn btn-danger btn-sm" href="{{ route('soft.delete10', $d->id) }}">
