...
@section('content')
    ...
    <div class="contact__container grid" style="padding-top: 100px">
        ...
        <form  class="contact__form o ">
           ...
           <a class=" btn btn-danger y   mb-1 pb-6 " href="{{ route('orders.index') }}" role="button">
    ...
    <div class="card" style="padding-top: 10px;">
        <div class="card" style="padding-top: 10px;">
            ...
            <div class="card-header">
                <h2 class="card-title" style="font-size:30px; font-weight:bold"> All Trashed Orders </h2>
            </div>
                ...
                <tbody>
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="{{ route('orderdReq.back.from.trash', $d->id) }}">
                                ...
                                <a class="btn btn-info btn-sm" style="background-color: black"
                                    href="{{ route('orderdReq.back.from.trash', $d->id) }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
